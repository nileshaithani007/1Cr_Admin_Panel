                ...
                <div className="predefined_styles">
                  {/* <div className="swichermainleft text-center">
                    <div className="p-3 d-grid gap-2">
                      <a href="https://react.spruko.com/sash/" className="btn ripple btn-primary mt-0" target='_blank'>View Demo</a>
                      
                      <Link to='https://themeforest.net/item/sash-react-admin-dashboard-template/39157113' className="btn ripple btn-secondary" target='_blank'>Buy Now</Link>
                  ...
                  {/* <div className="swichermainleft">
                    ...
                    <div className="skin-body switch_section">
                      ...
                      <div className="switch-toggle d-flex mt-2">
                        <Link className="bg-img1" to="#" onClick={() => SwitcherData.bgimage1()} ><img src={Imagesdata("bgimg1")} alt="Bg-1" id="bgimage1" /></Link>
                        <Link className="bg-img2" to="#" onClick={() => SwitcherData.bgimage2()}><img src={Imagesdata("bgimg2")} alt="Bg-2" id="bgimage2" /></Link>
                        <Link className="bg-img3" to="#" onClick={() => SwitcherData.bgimage3()}><img src={Imagesdata("bgimg3")} alt="Bg-3" id="bgimage3" /></Link>
                        <Link className="bg-img4" to="#" onClick={() => SwitcherData.bgimage4()}><img src={Imagesdata("bgimg4")} alt="Bg-4" id="bgimage4" /></Link>
                      </div>
                    </div>
                  </div> */}
