...
//               <img src={Imagesdata("logodark")} className="header-brand-img light-logo1" alt="logo" />
//             </Link>
...
//                                 <span className="country-selector"><img alt="" src={Imagesdata("flag")}
...
//                           <Dropdown.Item href={`${import.meta.env.BASE_URL}ecommerce/shoppingcart/`} className="d-flex p-4">

//                             <img className="avatar avatar-xl br-5 me-3 align-self-center cover-image" src={Imagesdata("product3")} alt='pngs-4' />
...
//                           <Link className="btn btn-primary btn-pill w-sm btn-sm py-2" to={`${import.meta.env.BASE_URL}Ecommerce/checkout/`}><i className="fe fe-check-circle"></i> Checkout</Link>
...
//                           <Dropdown.Item className="d-flex" href={`${import.meta.env.BASE_URL}pages/notificationlist/`}>
//                             <div
...
//                         <Dropdown.Item href={`${import.meta.env.BASE_URL}pages/notificationlist/`}
...
//                           <Dropdown.Item className="d-flex" href={`${import.meta.env.BASE_URL}apps/chat/`}>
//                             <img
...
//                         </div>
//                         <div className="dropdown-divider m-0"></div>
//                         <Dropdown.Item  className="text-center p-3 text-muted">See all
...
//                         </Dropdown.Item>
//                         <Dropdown.Item className="dropdown-item" href={`${import.meta.env.BASE_URL}pages/mailinbox/`}>
//                           <i className="dropdown-icon fe fe-mail"></i> Inbox
//                           <span className="badge bg-danger rounded-pill float-end">5</span>
//                         </Dropdown.Item>
//                         <Dropdown.Item className="dropdown-item" href={`${import.meta.env.BASE_URL}authentication/lockscreen/`}>
